...
## Prenos u projekat administrativnog sajta

Cijeli `docs` folder može se kopirati u drugi projekat kao dokumentacioni paket. U tom projektu Codexu treba zadati da prije implementacije pročita, ovim redom:
